...
export class FacultyTest extends React.Component<RouteComponentProps<{}>, FetchTestDataState> {
    constructor() {
        super();
        this.state = { gryfindor: 0, slytherin: 0, ravenclaw: 0, hufflepuff: 0, answerList: [], questionList: [], loading: true, path: "data:image/png;base64," };
    ...
    public render() {
        ...
        return <div className='lolikk'>
            <label className='lolik'>Розподіл на Факультет</label>
            <p />
            {contents}
        </div>;
