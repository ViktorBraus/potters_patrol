...
var AddBook = /** @class */ (function (_super) {
    ...
    function AddBook(props) {
        ...
        _this.state = { title: "", loading: true, BookData: new FetchEmployee_1.BookData, path: "data:image/png;base64," };
        ...
        // This will set state for Add employee
            ...
            _this.state = { title: "Create", loading: false, BookData: new FetchEmployee_1.BookData, path: "data:image/png;base64," };
        }
    ...
    AddBook.prototype.render = function () {
        ...
        return React.createElement("div", null,
            ...
            React.createElement(react_router_dom_1.NavLink, { to: "/fetchemployee" }, "\u041F\u043E\u0432\u0435\u0440\u043D\u0443\u0442\u0438\u0441\u044C \u0434\u043E \u0421\u043F\u0438\u0441\u043A\u0443 \u043A\u043D\u0438\u0433"),
    ...
    AddBook.prototype.renderCreateForm = function () {
        return (React.createElement("form", { className: 'formchange', onSubmit: this.handleSave },
            ...
            React.createElement("div", { className: "form-group col" },
                ...
                React.createElement("div", { className: "col-md-4 jj" },
                    React.createElement("input", { hidden: true, className: "form-control", type: "text", name: "Book_Image", defaultValue: this.state.BookData.book_Image.toString() }),
                    React.createElement("img", { name: 'book_Image', defaultValue: this.state.BookData.book_Image, width: "200", height: "auto", alt: "", src: this.state.path + this.state.BookData.book_Image }))),
