...
var AddGame = /** @class */ (function (_super) {
    ...
    AddGame.prototype.renderCreateForm = function () {
        return (React.createElement("form", { className: 'formchange', onSubmit: this.handleSave },
            ...
            React.createElement("div", { className: "form-group col" },
                React.createElement("label", { className: " control-label col-md-12 fl", htmlFor: "Name" }, "Game Name"),
                React.createElement("div", null,
                    React.createElement("input", { className: "nn", type: "text", name: "Game_Name", defaultValue: this.state.GameData.game_Name, required: true }))),
            React.createElement("div", { className: "form-group col" },
            ...
            React.createElement("div", { className: "form-group row" },
                React.createElement("label", { className: "control-label col-md-12 fl", htmlFor: "Department" }, "Game url"),
                React.createElement("div", null,
